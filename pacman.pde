...
void setup() {
  ...
  intro = minim.loadFile("audio/pacman_beginning.wav");
  intro.setGain(-12);
  chump = minim.loadFile("audio/pacman_chomp.wav");
  chump.setGain(-20);
  death = minim.loadFile("audio/pacman_death.wav");
  death.setGain(-10);
  speedUp = minim.loadFile("audio/pacman_speed.wav");
  speedUp.setGain(-12);
  god = minim.loadFile("audio/pacman_eatfruit.wav");
  god.setGain(-15);
  ghosts = minim.loadFile("audio/pacman_ghosts.wav");
  ghosts.setGain(-12);
